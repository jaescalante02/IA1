...
using namespace std;
  ...
  #include"pdb15-663.h"
  #define IA_PDB663
  #define TAMPATRON2 7 //6 + cero
  #define TAMPATRON 4 //3 + cero
  #define MULTINDEX2 11
  #define MULTINDEX 14
...
*/
  ...
  void acumulados(){
    ...
    unsigned long long aux = MULTINDEX;
...
int hashpdb663(NODO n,NODO n2, int mk){
    ...
    unsigned long long index1 = myhash(1,TAMPATRON2,acum2,v1.ficha);
    unsigned long long index2 = myhash(1,TAMPATRON2,acum2,v2.ficha);
    unsigned long long index3 = myhash(1,TAMPATRON,acum1,v3.ficha);
