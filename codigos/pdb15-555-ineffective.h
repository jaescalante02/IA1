...
void cargar(){
  ...
  string line;
  int i=0;
  ifstream file1("pdbs/pdb15_555_ineffective_first.txt");
  if (file1.is_open()){
    while (i<TAM_PATRON) {
      getline (file1,line);
  ...
  i=0;
  ifstream file2("pdbs/pdb15_555_ineffective_second.txt");
  if (file2.is_open()){
    while (i<TAM_PATRON) {
      getline (file2,line);
  ...
  i=0;
  ifstream file3("pdbs/pdb15_555_ineffective_third.txt");
  if (file3.is_open()){
    while (i<TAM_PATRON) {
      getline (file3,line);
